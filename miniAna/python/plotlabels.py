...
def variable_labels():
    ...
    variables["mu_pt"]  = Variable(binning=hpt.hist1d(50,0,500), label=r'Muon p'+_T)
    ...
    variables["tk_pt"]      = Variable(binning=hpt.hist1d(50,0,500), label=r'Track p'+_T)
    ...
    variables["tk_sinheta"] = Variable(binning=hpt.hist1d(10,-10,10), label=r'Track sinh('+_eta+')')
    variables["tk_rinv"]    = Variable(binning=10, label=r'Track Rinv')
    variables["tk_chi2"]    = Variable(binning=10, label=r'Track $\chi^\text{2}$')
    ...
    variables["tkmu_deltaR2"] = Variable(binning=hpt.hist1d(50,0,5), label=r'$\Delta$R(track,muon)')
